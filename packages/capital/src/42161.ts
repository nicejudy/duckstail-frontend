...
const bonds: BondConfigBaseProps[] = [
  ...
  },
  {
    ...
    lpBond: true,
    stableBond: false,
    token: getLPBondToken('0xE4CfAfF671De0b39695566e37Fe36eace0fd62dF'),
  ...
  },
  {
    ...
    lpBond: true,
    stableBond: false,
    token: getLPBondToken('0x168A4C3f7Bc744b05381D8F18588698179849556'),
  ...
  },
  {
    ...
    lpBond: true,
    stableBond: false,
    token: getLPBondToken('0xd5c1aB8c4E2021C713dC536C0fEc599d248C846D'),
    bondAddress: "0x8d3433f8ccfe4f9C3e54DD66006ABe73DbE13a8b"
  },
].map((b) => ({ ...b, bondToken: b.token.serialize }))
