...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and XKR pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and XKR pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from XKR pool', data)
  }
